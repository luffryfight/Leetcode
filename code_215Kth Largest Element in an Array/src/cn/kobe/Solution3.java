...
public class Solution3 {
     ...
     * */
    public static void qsort(int[] nums, int n) {
        _qsort(nums, 0, nums.length - 1);
    }
    ...
    private static void _qsort(int[] nums, int l, int r) {
        ...
        swap(nums, i, r - 1);
        _qsort(nums, 0, i - 1);//左半部分
        _qsort(nums, i + 1, r);//右半部分
